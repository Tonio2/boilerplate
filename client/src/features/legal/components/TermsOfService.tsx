        ...
        <div className="container mx-auto max-w-4xl flex-1 space-y-6 p-4 py-8">
            ...
            <Card>
                ...
                <CardContent className="prose prose-sm dark:prose-invert max-w-none">
                    <p className="text-muted-foreground">
                        By accessing and using this service operated by [Your Company Name] ("we",
                        "our", or "us"), you accept and agree to be bound by the terms and provision
                        of this agreement. If you do not agree to these Terms of Service, please do
                        not use our service.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mb-2 text-sm">You agree not to:</p>
                        <ul className="text-muted-foreground list-inside list-disc space-y-1 text-sm">
                            ...
                            <li>
                                Use the service for any automated data collection (scraping, bots,
                                etc.)
                            </li>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <p className="text-muted-foreground text-sm">
                        ...
                        by [Your Company Name] and are protected by international copyright,
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <div>
                        <h4 className="mb-2 text-sm font-semibold">By You</h4>
                        <p className="text-muted-foreground text-sm">
                            You may terminate your account at any time through the account settings
                            page. Upon termination, your data will be permanently deleted from our
                            servers.
                        </p>
                    </div>
                    <Separator />
                    <div>
                        <h4 className="mb-2 text-sm font-semibold">By Us</h4>
                        <p className="text-muted-foreground text-sm">
                            We may terminate or suspend your account immediately, without prior
                            notice, if you breach these Terms of Service. Upon termination, your
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <div>
                        <h4 className="mb-2 text-sm font-semibold">Service "As Is"</h4>
                        <p className="text-muted-foreground text-sm">
                    ...
                    <Separator />
                    <div>
                        <h4 className="mb-2 text-sm font-semibold">Limitation of Liability</h4>
                        <p className="text-muted-foreground text-sm">
                            ...
                            data, use, or other intangible losses, resulting from your access to or
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground text-sm">
                        You agree to indemnify, defend, and hold harmless [Your Company Name] and
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground text-sm">
                        ...
                        sole discretion. We will provide notice of any material changes by posting
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground text-sm">
                        ...
                        entire agreement between you and [Your Company Name] regarding the use of
